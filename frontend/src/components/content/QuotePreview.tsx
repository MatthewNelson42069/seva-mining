          ...
          <div className="space-y-1.5">
            <div className="flex items-center justify-between">
              ...
              <Button
                ...
                variant="ghost"
                onClick={() => {
                  navigator.clipboard.writeText(instagramPost)
            ...
            <div className="bg-muted/40 rounded-lg p-3">
              <p className="text-sm leading-relaxed whitespace-pre-wrap">{instagramPost}</p>
            </div>
          </div>
        )}
      </div>
