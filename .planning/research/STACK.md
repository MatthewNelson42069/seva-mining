...
**Domain:** AI social media monitoring, content drafting, and approval queue system
**Researched:** 2026-03-30
**Confidence:** HIGH (core stack pre-decided and verified; supporting library versions confirmed against PyPI/official docs)
...
uv init seva-backend
cd seva-backend
uv add "fastapi[standard]" sqlalchemy[asyncio] asyncpg alembic \
        apscheduler anthropic twilio tweepy apify-client \
        feedparser serpapi httpx pydantic-settings passlib bcrypt python-jose

# Dev dependencies
uv add --dev ruff pytest pytest-asyncio

# Frontend
npm create vite@latest seva-frontend -- --template react-ts
cd seva-frontend
...
**Scheduler deployment on Railway:**
...
engine = create_async_engine(
    DATABASE_URL,          # postgresql+asyncpg://.../dbname?sslmode=require
...
**Tailwind v4 Vite integration (no PostCSS file needed):**
```typescript
// vite.config.ts
...
---
*Stack research for: AI social media monitoring, content drafting, and approval queue system*
*Researched: 2026-03-30*
