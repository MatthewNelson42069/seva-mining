...
**Plans:** 4 plans
- [ ] 08-01-PLAN.md — Wave 0 validation scaffolding: vitest test stubs (XHandlePill, MarkdownContent, rehypeHandleMentions) + index.css token test + 4 grep scripts (UI-02/03/04 + pre-strip safety)
- [ ] 08-02-PLAN.md — Wave 1 UI polish: add 3 semantic amber tokens to index.css; apply hover:border-zinc-700 transition-colors to SummaryCard + SweeperCard; verify DayCell + SectionBlock (UI-01 / UI-02 / UI-03 / UI-04)
