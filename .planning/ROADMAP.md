...
- [x] 02-01-PLAN.md — NEW `scheduler/agents/ontario_law.py` (SerpAPI + NRCan + Haiku filter), wire `_build_ontario_law_section` in daily_summary.py, `LastKnownLaw` Pydantic model + dual config env var, comprehensive tests
